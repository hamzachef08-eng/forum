...
public final class I18n {
    ...
    static {
        ...
        fr.put("verify.code_title", "Vérification du compte");
        fr.put("verify.code_hint", "Entrez le code à 6 chiffres envoyé sur Gmail.");
        fr.put("verify.code_label", "Code à 6 chiffres");
        fr.put("verify.code_submit", "Vérifier le compte");
        fr.put("verify.code_resend", "Renvoyer le code");
        fr.put("verify.code_sent", "Code de vérification envoyé.");
        fr.put("verify.code_wait", "Veuillez attendre {0} secondes avant de renvoyer.");
        fr.put("verify.code_bad", "Code invalide ou expiré.");
        ...
        fr.put("home.kicker", "Forum collaboratif");
        fr.put("home.title", "Apprendre ensemble, discuter plus vite");
        fr.put("home.subtitle", "Une plateforme EST Agadir pour échanger par modules, publier des blogs et collaborer en communauté.");
        fr.put("home.card.modules", "Espaces modules");
        fr.put("home.card.modules_text", "Chat dédié pour chaque module de votre filière et semestre.");
        fr.put("home.card.blog", "Blog étudiant");
        fr.put("home.card.blog_text", "Publiez vos idées, commentez et suivez les échanges.");
        fr.put("home.card.admin", "Modération");
        fr.put("home.card.admin_text", "Signalement, bannissement et gestion admin centralisée.");
        fr.put("home.card.secure", "Accès sécurisé");
        fr.put("home.card.secure_text", "Connexion, vérification email et récupération par code.");
        fr.put("home.login", "Se connecter");
        fr.put("home.register", "Créer un compte");

        en.put("register.verify.sent", "Account created. Please verify your email before login.");
        en.put("verify.code_title", "Account verification");
        en.put("verify.code_hint", "Enter the 6-digit code sent to Gmail.");
        en.put("verify.code_label", "6-digit code");
        en.put("verify.code_submit", "Verify account");
        en.put("verify.code_resend", "Resend code");
        en.put("verify.code_sent", "Verification code sent.");
        en.put("verify.code_wait", "Please wait {0} seconds before resending.");
        en.put("verify.code_bad", "Invalid or expired code.");
        ...
        en.put("home.kicker", "Collaborative forum");
        en.put("home.title", "Learn together, discuss faster");
        en.put("home.subtitle", "An EST Agadir platform to chat by modules, publish blogs, and collaborate as a community.");
        en.put("home.card.modules", "Module spaces");
        en.put("home.card.modules_text", "Dedicated chat for each module in your track and semester.");
        en.put("home.card.blog", "Student blog");
        en.put("home.card.blog_text", "Publish ideas, comment, and follow discussions.");
        en.put("home.card.admin", "Moderation");
        en.put("home.card.admin_text", "Reporting, banning, and centralized admin management.");
        en.put("home.card.secure", "Secure access");
        en.put("home.card.secure_text", "Login, email verification, and code-based recovery.");
        en.put("home.login", "Log in");
        en.put("home.register", "Create account");
